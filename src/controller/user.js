      ...
      if (checkDataUser.length > 0) {
        ...
        if (userId !== null) {
          ...
          const mailOptions = {
            ...
            <p>I am here to send you the access link to Muse Coffee. Please, click <a href="https://vigorous-wright-316484.netlify.app/activate/${userId}">this</a> to activate your account.</p>
